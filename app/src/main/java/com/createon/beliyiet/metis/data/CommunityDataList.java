...
public class CommunityDataList extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        mDateList = filledData(getResources().getStringArray(R.array.community));
        ...
        mRecyclerView.addItemDecoration(new DividerItemDecoration(CommunityDataList.this, DividerItemDecoration.VERTICAL));
    ...
    private void filterData(String filterStr) {
        ...
        if (TextUtils.isEmpty(filterStr)) {
            filterDateList = filledData(getResources().getStringArray(R.array.community));
        } else {
